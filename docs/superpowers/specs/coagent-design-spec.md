...
| 4 | 怎么做到可验证 | Playbook + Decision Score + 审计链 |
...
| 2 | **买什么：** Agent Ops Copilot — 事件接入 + 因果处置 + **Decision Score** + 飞书协同 + 留痕复盘 | 不是告警换壳 |
| 3 | **ROI（可量化）：** 少漏单 · 少瞎改 · 少烧钱 · 控得住 / 查得着 | 对应 §1.4 价值表 |
| 4 | **为什么敢用：** Human-in-loop（🟢🟡🔴）+ 三因子 Score 可追问 — 零幻觉 Ops | 企业采购卡点 |
...
| 页 | Bullets |
|----|---------|
| **2** | 用户价值一句话 · 因果一跳 · Score 可验证 · Human-in-loop · 三场景切面（§1.4–§1.5） |
